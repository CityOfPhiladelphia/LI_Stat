...
def update_table_data(selected_start, selected_end, selected_permittype, selected_worktype):
    ...
    df_selected_grouped = (df_selected.loc[(df_selected['Permit Application Date'] >= selected_start) & (df_selected['Permit Application Date'] <= selected_end)]
...
def update_footnote(selected_start, selected_end, selected_permittype, selected_worktype):
    ...
    if selected_worktype != "All":
        df_selected = df_selected[(df_selected['Work Type'] == selected_worktype)]
    df_selected = df_selected.loc[(df_selected['Permit Application Date'] >= selected_start) & (df_selected['Permit Application Date'] <= selected_end)]
